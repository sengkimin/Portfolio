...
// // import img from "../public/images/new1.jpg";
// // import "animate.css";
...
// //                   active === item ? "text-teal-400 font-semibold" : ""
// //                 }`}
...
// //           {/* Search Icon */}
// //           <div className="hidden lg:block text-gray-300 text-lg cursor-pointer hover:text-white">🔍</div>
...
// //           <div className="container mx-auto flex flex-col lg:flex-row items-center justify-between md:mt-24">
// //             {/* Text Section */}
...
// //                   href="/cv.pdf"
// //                   download
// //                   className="bg-teal-500 text-white py-3 px-6 rounded-md text-md font-medium hover:bg-teal-600 transition"
// //                 >
// //                   Download CV
// //                 </a>
// //                 <a
// //                   href="https://github.com/sengkimin"
// //                   target="_blank"
// //                   rel="noopener noreferrer"
// //                   className="bg-gray-800 text-white py-3 px-6 rounded-md text-md font-medium hover:bg-gray-700 transition"
// //                 >
// //                   GitHub
// //                 </a>
// //               </div>
...
// //                   className="rounded-2xl bg-cyan-500 shadow-md shadow-teal-400 transform transition-transform duration-700 hover:scale-110 cursor-pointer"
// //                   layout="fill"
// //                   objectFit="cover"
// //                 />
// //               </div>
